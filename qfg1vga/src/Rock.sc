...
(procedure (localproc_03b2 param1)
	...
	(= local3 (GetTime 1))
	(if (!= local4 19)
		(= global257 (+ 2 (/ [gStrength param1] 10)))
...
(procedure (localproc_03e5 &tmp [temp0 2])
	(= global257 0)
	(if (!= local4 19) (timeBar value: global257 draw:))
	(switch local4
		(23
...
(instance timeBar of pointBar
	...
	(method (draw)
		(super draw:)
		(if (== valCel 10) (candleFlame setCycle: Fwd))
		(if (> valCel 2)
...
(instance wizGame of Rm
	...
	(method (init &tmp temp0 temp1 temp2 temp3 temp4)
		(proc958_0 130 238 205 810)
		(proc958_0 128 32 33 803)
		Cat
		ForwardCounter
		(super init:)
		(gMainIconBar disable: 1 2 3 4 5 6 7 8)
		(gGame setCursor: 942 1)
		(proc0_5 359)
		(++ global417)
		(proc814_26 616 5 1)
		(= local14 1)
		(gMH add: gNewCast gNewFeatures)
		...
		(pointBar max: (proc814_22) value: [gStrength 16] init:)
		(= global257 0)
		(timeBar init:)
		(playerBug
			setLoop: 0
	...
	(method (doit &tmp temp0 temp1)
		(if (!= theGStrength [gStrength 16])
			(= theGStrength [gStrength 16])
			(pointBar value: theGStrength draw:)
		)
		(if
		(and global257 (!= (= temp0 (GetTime 1)) local3))
			(= local3 temp0)
			(if (-- global257)
				(timeBar value: global257 draw:)
			else
	...
	(method (dispose)
		...
		(gMH delete: self)
		(gKH delete: self)
		(gMH delete: gNewCast gNewFeatures)
		(gMainIconBar enable:)
		(gMainIconBar enable: 1 2 3 4 5 6 7 8)
		(proc0_6 359)
		(if (HaveMouse)
			(gGame setCursor: global20 1)
		else
	...
	(method (cue &tmp temp0 temp1 [temp2 150])
		(cond 
			(local11 (global2 newRoom: 31))
			(local14 (= local14 0) (gQg1Messager say: 4 0 6 1))
			((proc0_7 337) (= local11 1) (gQg1Messager say: 4 0 4 1 self))
			(((wizBug mover?) completed?) (= local11 1) (gQg1Messager say: 4 0 5 0 self))
			((not (gEgo knows: 20))
				(= local11 1)
				...
				(proc921_1
					@temp2
					{"ובכן, נראה שיש לך מזל של מתחילים. לקח לך רק %d משחק%d כדי לנצח. המפף. בדרך כלל נדרשים לפחות %d נסיונות על מנת להביס אותי למי שאינו בדרגת אשף מושלם."}
					global417
					temp1
					temp0
				)
				(gEgo learn: 20 10)
				(proc814_26 617 12 1)
				(gQg1Messager say: 4 0 2 0 self)
			)
			(else (= local11 1) (gQg1Messager say: 4 0 3 0 self))
		)
	)
)
...
(instance timeScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0 (= ticks 30))
			(1
				(if (gEgo has: 13) (gQg1Messager say: 1))
			)
		)
	)
)
...
(instance chooseSpell of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(if (not (HaveMouse))
					(gGame
						setCursor: gCursorNumber 1 [local221 global187] 175
					)
				)
				(objectList empty:)
				(localproc_0294)
	...
	(method (handleEvent pEvent &tmp [temp0 3] pEventX pEventY)
		(if
			(and
				(== (pEvent message?) KEY_RETURN)
				(== (pEvent type?) evKEYBOARD)
		...
		(return
			(cond 
				...
				(
					(and
						(<= JOY_UP (pEvent message?))
						(<= (pEvent message?) JOY_UPLEFT)
					)
					(objectList handleEvent: pEvent)
				)
				((== (pEvent type?) evMOUSEBUTTON)
					...
					(pEvent claimed: 1)
					(cond 
						((localproc_02e5 pEventX pEventY 65 150 85 185)
							(if (<= [gStrength 16] 0)
								(if (not local14) (proc0_5 337) (self dispose:))
								(wizGame cue:)
							else
								(= global187 0)
								(= global188 2)
						...
						((localproc_02e5 pEventX pEventY 112 154 132 184)
							(if (<= [gStrength 16] 0)
								(if (not local14) (proc0_5 337) (self dispose:))
								(wizGame cue:)
							else
						...
						((localproc_02e5 pEventX pEventY 172 168 192 198)
							(if (<= [gStrength 16] 0)
								(if (not local14) (proc0_5 337) (self dispose:))
								(wizGame cue:)
							else
						...
						((localproc_02e5 pEventX pEventY 215 155 235 190)
							(if (<= [gStrength 16] 0)
								(if (not local14) (proc0_5 337) (self dispose:))
								(wizGame cue:)
							else
						...
						((localproc_02e5 pEventX pEventY 7 158 43 188)
							(if (gEgo has: 13)
								(= local14 1)
								(proc814_18 (- (/ (proc814_22) 2)))
								(gEgo use: 13)
								(gEgo get: 11)
								(gMainIconBar disable: 6)
								(gQg1Messager say: 2)
							else
								(gQg1Messager say: 3)
							)
...
(instance doFlame of Script
	...
	(method (handleEvent pEvent &tmp temp0 temp1 temp2 pEventMessage)
		(cond 
			(
				(and
					(== (pEvent message?) KEY_ESCAPE)
			...
			(
				...
				(= temp1 [local225 (= pEventMessage (pEvent message?))])
				(= temp2 [local234 pEventMessage])
				(cond 
			...
			((== (pEvent type?) evMOUSEBUTTON)
				(pEvent claimed: 1)
				(= global257 (+ 4 (/ [gStrength 23] 5)))
				(flame posn: (pEvent x?) (pEvent y?) setCycle: Fwd)
				(= global188 1)
				(self dispose:)
			)
			(
